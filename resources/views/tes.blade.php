                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" name="produk_id" id="id"
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="email2" name="id_masuk"
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" placeholder="Stok Masuk" name="stok" id="stok"
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control" id="datepicker"
                                                        name="tanggal_expired" name="datepicker"
