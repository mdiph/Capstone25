                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a class="btn btn-primary btn-round ml-auto" href="/barangmasuk">
                                ...
                                <div class="modal fade" id="ReturnRowModal{{ $d->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="/barangmasuk/kembali/{{ $d->id }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <h4>Apakah Anda Ingin Mengembalikan Data
                                                        <strong>{{ $d->id_masuk }}</strong>? </h4>
                                                </div>
                                ...
                                <div class="modal fade" id="DeleteRowModal{{ $d->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="/barangmasuk/forcedelete/{{ $d->id }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <h4>Apakah Anda Ingin Menghapus Data
                                                        <strong>{{ $d->id_masuk }}</strong>? </h4>
                                                </div>
