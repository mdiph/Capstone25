                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    <h4 class="card-title">User Trash</h4>
                                    <a class="btn btn-primary btn-round ml-auto" href="/User">
                                ...
                                <div class="modal fade" id="ReturnRowModal{{ $d->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="/user/kembali/{{ $d->id }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <h4>Apakah Anda Ingin Mengembalikan Data User <strong>{{ $d->nama }}</strong>? </h4>
                                                </div>
                                ...
                                <div class="modal fade" id="DeleteRowModal{{ $d->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="/user/forcedelete/{{ $d->id }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <h4>Apakah Anda Ingin Menghapus Data User <strong>{{ $d->nama }}</strong>? </h4>
                                                </div>
